                            ...
                            <div class="tab-pane fade active show" id="pills-personal" role="tabpanel" aria-labelledby="pills-personal-tab">
                                ...
                                <div class="media"><img class="img-50 img-fluid m-r-20 rounded-circle update_img_0" src="../assets/images/user/2.png" alt="">
                                    <div style="margin-top: 10px;" class="media-body">
                                        <h6> <span class="first_name_0">{{$t->tamu->nama}} </span><span class="last_name_0"></span></h6>
                                    </div>
                                                        ...
                                                        <table class="table table-bordernone">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td style="font-size: 11px;">{{$t->stok->harga_retail}}</td>
                                ...
                                <div class="col-xl-4">
                                    ...
                                    <div class="email-left-aside">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="{{url('ad_cetak_tab')}}"><button class="btn btn-success m-r-10" type="button" title="">Cetak Struk</button></a>

                                        </div>
                                        <div class="card-body">

                                            <a href="{{ url('ad_bayar/'.$t->id) }}"><button class="btn btn-warning m-r-10" type="button" title="">Pembayaran</button></a>
