                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-inline-block align-middle"><img class="img-40 m-r-15 rounded-circle align-top" src="../assets/images/avtar/7.jpg" alt="">
                                                ...
                                                <div class="d-inline-block"><span>{{$t->tamu->nama}}</span>
                                        ...
                                        <td>{{$t->stok->produk}}</td>
                                        <td>{{$t->status}}</td>
                                        <td><a href="{{ url('ad_trtamu/'.$t->id) }}"><button class="btn btn-success m-r-10" type="button" title="">Detail</button></a></td>
