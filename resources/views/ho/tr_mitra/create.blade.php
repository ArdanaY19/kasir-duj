...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-12">
            ...
            <form class="form theme-form" method="POST" action="{{url('ho_trmitra')}}">
                <div class="card-body">
                    {{-- baris 1 --}}
                    <div class="row mb-3">
                        <div class="col-xl-6">
                    ...
                    <div class="row mb-2">
                        <div class="col-xl-6">
                            <label class="form-label" for="exampleFormControlInput1"><strong>Nama HO :</strong>
                                indra</label>
                        </div>
                        <div class="col-xl-6">
                                                ...
                                                <table class="table table-bordernone">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Jember</td>
                                                            <td>08121831893</td>
                                                            <td><a href="#" data-bs-original-title="" title=""><button class="btn btn-success m-r-10" type="button" title="" data-bs-original-title="">Detail</button></a>
                                                            </td>
                                                        </tr>
                                                        <!-- loop data -->
                                                    </tbody>
