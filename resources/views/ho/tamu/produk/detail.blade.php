                                ...
                                <div class="col-xl-4">
                                    ...
                                    <div class="email-left-aside">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="#"><button class="btn btn-primary" type="button" title="">Unduh</button></a>
                                        </div>
                                        <div class="card-body">

                                            <a href="{{ url('ho_produk/'.$p->id.'/edit') }}"><button class="btn btn-success" type="button" title="">Ubah Data</button></a>
                                        </div>
                                    </div>
