    ...
    <div class="page-title pt-3 ">
        <div class="row">
            <div style="color: #7366FF;" class="col-6">
                <h3>Ubah Data Ganti Produk</h3>
            </div>
            <div class="col-6">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html"><i data-feather="home"></i></a></li>
                    <li class="breadcrumb-item">Dashboard</li>
                    <li class="breadcrumb-item active">Ubah Data Ganti Produk</li>
                </ol>
            </div>
        </div>
    </div>
                                                ...
                                                <div class="table-responsive product-list">
                                                    ...
                                                    <table class="table table-bordernone">
                                                        <tbody>
                                                            <tr>
                                                                <!-- loop data -->
                                                                <th style="font-size: 14px;">Jontono</th>
                                                            </tr>
                                                            <tr>
                                                        ...
                                                        <div class="card-body">
                                                            <table>
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input class="form-control" id="exampleFormControlInput1" value="10" type="text">
                                                                </div>
                                                            </table>
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <table>
                                                                ...
                                                                <div class="mb-3">
                                                                    <label class="form-label" for="exampleFormControlInput1">Nama Produk</label>
                                                                    <input class="form-control" id="exampleFormControlInput1" value="hp" type="text">
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label class="form-label" for="exampleFormControlInput1">harga Produk</label>
                                                                    <input class="form-control" id="exampleFormControlInput1" value="10" type="text">
                                                            ...
                                                            <div class="table-responsive product-list">
                                                                ...
                                                                <table class="table table-bordernone">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input class="form-control" id="exampleFormControlInput1" value="2" type="number">
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        Status Verifikasi
                                                                        <div class="col">
