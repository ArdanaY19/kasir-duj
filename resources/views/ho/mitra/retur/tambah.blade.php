    ...
    <div class="page-title pt-3 ">
        <div class="row">
            <div style="color: #7366FF;" class="col-6">
                <h3>Tambah Retur Mitra</h3>
            </div>
            <div class="col-6">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html"><i data-feather="home"></i></a></li>
                    <li class="breadcrumb-item">Dashboard</li>
                    <li class="breadcrumb-item active">Tambah Retur Mitra</li>
                </ol>
            </div>
        </div>
    </div>
                        ...
                        <div class="tab-content">
                            <div class="row">
                                ...
                                <div class="col-xl-4">
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <label class="form-label" for="exampleFormControlInput1">Tanggal Retur</label>
                                                ...
                                                <div class="card">
                                                    <div class="card-body ">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="mb-3">
                                                                <label class="form-label" for="exampleFormControlTextarea1"><strong>Keterangan Retur Produk 2</strong></label>
                                                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" value="" type="text"></textarea>
                                                            </div>
                                                            <div class="mb-3">
                                                                <h6>Pernyataan Retur Produk 1</h6>
                                                                <a href="#"><button class="btn btn-primary" type="button" title="">Tambah</button></a>
                                                            </div>
                                                            <div class="mb-3">
                                                                <h6>Foto Retur Produk 1</h6>
                                                                <a href="#"><button class="btn btn-primary" type="button" title="">Tambah</button></a>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="mb-3">
                                                                <label class="form-label" for="exampleFormControlTextarea2"><strong>Keterangan Retur Produk 2</strong></label>
                                                                <textarea class="form-control" id="exampleFormControlTextarea2" rows="3" value="" type="text"></textarea>
                                                            </div>
                                                            <div class="mb-3">
                                                                <h6>Pernyataan Retur Produk 2</h6>
                                                                <a href="#"><button class="btn btn-primary" type="button" title="">Tambah</button></a>
                                                            </div>
                                                            <div class="mb-3">
                                                                <h6>Foto Retur Produk 2</h6>
                                                                <a href="#"><button class="btn btn-primary" type="button" title="">Tambah</button></a>
                                                            </div>
                                                        </div>
                                                    </div>
