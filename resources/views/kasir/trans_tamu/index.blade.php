                    ...
                    <div class="best-seller-table responsive-tbl">
                        <div class="item">
                            ...
                            <table class="hover" id="example-style-4">
                                ...
                                <!-- loop data -->
                                <?php $no = 1; ?>
                                @foreach ($transaksis as $value=>$transaksi)
                                <tbody>
                                    <tr>
                                        <td>{{$no++}}</td>
                                        <td>
                                            <div class="d-inline-block align-middle"><img class="img-40 m-r-15 rounded-circle align-top" src="../assets/images/avtar/7.jpg" alt="">
                                                ...
                                                <div class="d-inline-block"><span>{{$transaksi->nama}}</span>
                                                    <p class="font-roboto">2019</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td>{{$transaksi->tanggal}}</td>
                                        <td>{{$transaksi->namaS}}</td>
                                        <td>{{$transaksi->produk}}</td>
                                        <td>{{$transaksi->status}}</td>
                                        <td><a href="{{ url('kas/transtamu/'.$transaksi->id) }}"><button class="btn btn-success m-r-10" type="button" title="">Detail</button></a></td>
