                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div class="d-inline-block align-middle"><img class="img-40 m-r-15 rounded-circle align-top" src="../assets/images/avtar/7.jpg" alt="">
                                                                                    ...
                                                                                    <div class="d-inline-block"><span>{{$tabungan->nama}}</span>
                                                                                        <p class="font-roboto">2019</p>
                                                                                    </div>
                                                                                </div>
                                                                            </td>
                                                                            <td>{{$tabungan->namaS}}</td>
                                                                            <td>{{$tabungan->namacenter}}</td>
                                                                            <td>{{$tabungan->produk}}</td>
                                                                            <td>{{$tabungan->status}}</td>
                                                                            <td><a href="{{ url('kas/tabtamu/'.$tabungan->id) }}"><button class="btn btn-success m-r-10" type="button" title="">Detail</button></a></td>
                                                                        </tr>
