                ...
                <table class="display" id="advance-12">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>2</td>
                            <td>Diverifikasi</td>
                            <td><a href="#"><button class="icon-file btn btn-primary" type="button" title=""></button></a><a href="{{ url('/detaildatagantiproduktamuKC') }}"><button class="icon-eye btn btn-success" type="button" title=""></button></a></td>
